...
class ParserModel(Model):
    ...
    def add_embedding(self):
        ...
        """
        ### YOUR CODE HERE
        lexicon = tf.Variable(self.pretrained_embeddings)
        features = tf.nn.embedding_lookup(lexicon, self.input_placeholder)
    ...
    def add_prediction_op(self):
        ...
        prob = 1 - self.dropout_placeholder
        #prob = self.dropout_placeholder
        h_drop = tf.nn.dropout(h, prob)
